...
public class Servidor7 {
    ...
    public void rodar() throws IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            byte[] bufferCalculadora7 = pacoteEntrada.getData();
            ByteArrayInputStream bais = new ByteArrayInputStream(bufferCalculadora7);
            ObjectInputStream ois = new ObjectInputStream(bais);
            Calculadora7 calculadora = (Calculadora7) ois.readObject();
