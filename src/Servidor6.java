...
public class Servidor6 {
    ...
    public void rodar() throws IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            byte[] bufferCalculadora6 = pacoteEntrada.getData();
            ByteArrayInputStream bais = new ByteArrayInputStream(bufferCalculadora6);
            ObjectInputStream ois = new ObjectInputStream(bais);
            Calculadora6 calculadora = (Calculadora6) ois.readObject();
